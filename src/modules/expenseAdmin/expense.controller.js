...
router.post('/create-expense-accountant', auth, upload("receipt"), uploadToCloudinary(false, "single"), checkRole("Admin", "SAdmin", "Accountant", "Operation"), createExpenseHandler)
